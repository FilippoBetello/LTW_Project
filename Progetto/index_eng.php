    ...
    <body id="page-index">
        ...
        <nav id="navbar">
          ...
          <ul class="ul-nav" >
            ...
            <li><a href="stamparec_eng.php" id="recensioni"><b>REVIEWS</b></a></li>
            <li><a href="index.php"><img src="bandiera-italia.png"  style="width:30px; height: 20px;" id="bandiera"></a></li>
          </ul>
    ...
    <div class="center">
     ...
     <div class="conta" id="container">
         ...
         <div class="form-box">
             ...
             <form id="login" class="inpu-group" action="login.php?pag=index_eng.php" method="POST">
             ...
             <form id="signin" class="inpu-group" action="registrazione.php?pag=index_eng.php" method="POST">
     ...
     <div class="contenitori"> 
      ...
      <div class="contenitore1">
        <div class="descrizione">
          <h2 href="" style="color: darkred;">Panoramic spots</h2>
          <p>Rome offers many panoramic points and extraordinary views, each with its own particularity,
            from which enjoy a fantastic view and from which to grasp all the magnificence
            of the city from a privileged perspective. </p>
        </div>
        ...
        <div class="contenitore1">
          <div class="descrizione2">
            <h2 href="" style="color: darkred;">Unusual places</h2>
          <p>Walking through the city you often come across places with particular characteristics. People who don't pay much attention to what is around them may lose lots of places, but if you look carefully you can be pleasantly surprised.</p>
          </div>
        ...
        <div class="contenitore1">
          <div class="descrizione">
            <h2 href="" style="color: darkred;">Outside Rome</h2>
            <p>In short distance from Rome there are lots of typical towns and places, each of them characterized by a different detail, excellent for making a nice day trip out of the traffic and smog of the city. The beauties in our territory are endless, try to believe!            
            </p>
          </div>
          <div class="flip-box" >
            <div class="flip-box-inner">
      ...
      <h1 class="descr1 animated infinite bounce" >YOUR EXPERIENCES</h1>
      ...
      <div class="slideshow-container">
        ...
        <div class="mySlides fade" >
            ...
            <p class="descr2">
              A fantastic place to admire Rome. I suggest you to take takeaway pizzas and eat in front of this amazing view.
              You will not regret it!! I will definetely be back, such a romantic place. 
            </p>
        ...
        <div class="mySlides fade">
          ...
          <p class="descr2">
            A jewel in the middle of Villa Ada! The perfect location for photos and videos. 
            I hope it will be restored and the municipal gardeners will do their job.  
          </p>
      </div>
      ...
      <div class="mySlides fade">
        ...
        <p class="descr2">
          A lovely place. It is perfect for a day trip. 
          You can get in only through a bridge. The village is small but really nice. I truly suggest it
        </p>
    </div>
    </a>
      </div>
      ...
      <div class="col-md-12">
          <div class="row ">
              ...
              <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4">
               <h6 class="mt-55 mt-2 bold-text"><a href="recensione.php?pag=index_eng.php"><b>Send a review</b></a></h6> <!--INSERIRE LINK-->
                  <!-- <small> 
                       <span>
          ...
          <div class="row ">
              <div class="col-xl-8 col-lg-8 col-md-6 col-sm-4 col-4 mx-auto my-auto mt-5 order-sm-1 order-3 align-self-end text-center">
               ...
               <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 order-1 align-self-end ">
                   <h6 class="mt-55 mt-2 bold-text"><a href="suggerimento.php?li=en"><b>Suggestions</b></a></h6>
                  <!-- <small> 
                       <span>
                           <i class="fa fa-envelope" aria-hidden="true"></i>
                        </span> 
